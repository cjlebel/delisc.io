...
const scssFolder = './wwwroot/scss';
//fs.readdirSync(scssFolder).forEach((entryFolder) => {
//    const entryPath = `./${path.join(scssFolder, entryFolder, 'site.tsx')}`;
//    if (fs.existsSync(entryPath)) {
//        entryPoints[entryFolder] = entryPath;
//    }
//});

entryPoints[scssFolder] = `./${path.join(scssFolder, 'site.scss')}`;
